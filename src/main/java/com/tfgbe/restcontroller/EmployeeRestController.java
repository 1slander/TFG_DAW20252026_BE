...
public class EmployeeRestController {
    ...
    public ResponseEntity<List<EmployeeResponseDto>> getRestaurantEmployees() {
        return ResponseEntity.ok(employeeService.findMyRestaurantEmployees());
    }
    ...
    public ResponseEntity<String> changeMyPassword(@RequestBody @Valid ChangePasswordDto changePasswordDto) {
        employeeService.changeMyPassword(changePasswordDto);
